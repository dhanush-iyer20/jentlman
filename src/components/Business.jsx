...
const FeatureCard = ({index,icon,title,content})=>{
  return (<div className={`flex flex-row p-6 rounded-[20px] ${index!==features.length-1 ? "mb-6" : "mb-0"} feature-card`}>
    <div className={`w-[64px] h-[64px] rounded-4 bg--dimBlue ${styles.flexCenter}`}>
  ...
  return (
    <section id='featues' className={`${layout.section}`}>
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>Cleans the pores <br className='sm:block hidden'/> of your face</h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>This facewash was made with care and attention and would work wonders on all types of skin</p>
      </div>
